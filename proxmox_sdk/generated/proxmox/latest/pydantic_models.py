...
GENERATED_SOURCE_SHA256 = "45f8e0721ca8090700acbc3ac79bd7a9d8d918be39c6995a47fb22f95a0ca6bf"
GENERATED_AT = "2026-04-11T00:44:11Z"
...
class PostAccessDomainsRequest(ProxmoxBaseModel):
    ...
    autocreate: bool | None = Field(
        None, description="Automatically create users if they do not exist."
    )
    ...
    case_sensitive: bool | None = Field(
        None, alias="case-sensitive", description="username is case-sensitive"
    )
    ...
    check_connection: bool | None = Field(
        None, alias="check-connection", description="Check bind connection to the server."
    )
    ...
    groups_autocreate: bool | None = Field(
        None,
        alias="groups-autocreate",
        description="Automatically create groups if they do not exist.",
    )
    groups_claim: str | None = Field(
        None, alias="groups-claim", description="OpenID claim used to retrieve groups with."
    )
    groups_overwrite: bool | None = Field(
        None,
        alias="groups-overwrite",
    ...
    password: str | None = Field(
        None, description="LDAP bind password. Will be stored in '/etc/pve/priv/realm/<REALM>.pw'."
    )
    ...
    query_userinfo: bool | None = Field(
        None,
        alias="query-userinfo",
    ...
    secure: bool | None = Field(
        None, description="Use secure LDAPS protocol. DEPRECATED: use 'mode' instead."
    )
...
class PostAccessDomainsRealmSyncRequest(ProxmoxBaseModel):
    dry_run: bool | None = Field(
        None, alias="dry-run", description="If set, does not write anything."
    )
    enable_new: bool | None = Field(
        None, alias="enable-new", description="Enable newly synced users immediately."
    )
    ...
    remove_vanished: str | None = Field(
        None,
...
class PutAccessPasswordRequest(ProxmoxBaseModel):
    confirmation_password: str | None = Field(
        None,
        alias="confirmation-password",
...
class GetAccessTfaResponse(RootModel[list[GetAccessTfaResponseItem]]):
    root: list[GetAccessTfaResponseItem] = Field(
...
class GetAccessTfaUseridResponse(RootModel[list[GetAccessTfaUseridResponseItem]]):
    root: list[GetAccessTfaUseridResponseItem] = Field(
...
class PostAccessTfaUseridRequest(ProxmoxBaseModel):
    challenge: str | None = Field(
        None, description="When responding to a u2f challenge: the original challenge string"
    )
    description: str | None = Field(
        None, description="A description to distinguish multiple entries from one another"
    )
    password: str | None = Field(
        None, description="The current password of the user performing the change."
    )
...
class PostAccessTicketRequest(ProxmoxBaseModel):
    new_format: bool | None = Field(
        None, alias="new-format", description="This parameter is now ignored and assumed to be 1."
    )
    ...
    path: str | None = Field(
        None, description="Verify ticket, and check if user have access 'privs' on 'path'"
    )
...
class GetAccessUsersResponseItem(ProxmoxBaseModel):
    ...
    realm_type: str | None = Field(
        None, alias="realm-type", description="The type of the users realm"
    )
    tfa_locked_until: int | None = Field(
        None,
        alias="tfa-locked-until",
...
class PostClusterAcmeAccountRequest(ProxmoxBaseModel):
    ...
    eab_hmac_key: str | None = Field(
        None, alias="eab-hmac-key", description="HMAC key for External Account Binding."
    )
    eab_kid: str | None = Field(
        None, alias="eab-kid", description="Key Identifier for External Account Binding."
    )
    name: str | None = Field(None, description="ACME account config file name.")
    tos_url: str | None = Field(
        None, description="URL of CA TermsOfService - setting this indicates agreement."
    )
...
class GetClusterAcmeChallengeSchemaResponse(
    RootModel[list[GetClusterAcmeChallengeSchemaResponseItem]]
):
...
class GetClusterAcmeMetaResponse(ProxmoxBaseModel):
    caa_identities: list[str] | None = Field(
        None, alias="caaIdentities", description="Hostnames referring to the ACME servers."
    )
    external_account_required: bool | None = Field(
        None, alias="externalAccountRequired", description="EAB Required"
    )
    terms_of_service: str | None = Field(
        None, alias="termsOfService", description="ACME TermsOfService URL."
    )
...
class GetClusterAcmePluginsResponseItem(ProxmoxBaseModel):
    ...
    validation_delay: int | None = Field(
        None,
...
class PostClusterBackupRequest(ProxmoxBaseModel):
    ...
    exclude_path: list[str] | None = Field(
        None,
        alias="exclude-path",
    ...
    lockwait: int | None = Field(
        None, description="Maximal time to wait for the global lock (minutes)."
    )
    mailnotification: str | None = Field(
        None,
    ...
    pool: str | None = Field(
        None, description="Backup all known guest systems included in the specified pool."
    )
    ...
    remove: bool | None = Field(
        None, description="Prune older backups according to 'prune-backups'."
    )
    ...
    schedule: str | None = Field(
        None, description="Backup schedule. The format is a subset of `systemd` calendar events."
    )
    ...
    stopwait: int | None = Field(
        None, description="Maximal time to wait until a guest system is stopped (minutes)."
    )
...
class GetClusterBackupInfoNotBackedUpResponse(
    RootModel[list[GetClusterBackupInfoNotBackedUpResponseItem]]
):
    root: list[GetClusterBackupInfoNotBackedUpResponseItem] = Field(
...
class PostClusterBulkActionGuestMigrateRequest(ProxmoxBaseModel):
    maxworkers: int | None = Field(
        None, description="How many parallel tasks at maximum should be started."
    )
    online: bool | None = Field(
        None, description="Enable live migration for VMs and restart migration for CTs."
    )
    ...
    with_local_disks: bool | None = Field(
        None, alias="with-local-disks", description="Enable live storage migration for local disk"
    )
...
class PostClusterBulkActionGuestShutdownRequest(ProxmoxBaseModel):
    force_stop: bool | None = Field(
        None, alias="force-stop", description="Makes sure the Guest stops after the timeout."
    )
    maxworkers: int | None = Field(
        None, description="How many parallel tasks at maximum should be started."
    )
    timeout: int | None = Field(
        None, description="Default shutdown timeout in seconds if none is configured for the guest."
    )
    vms: list[int] | None = Field(None, description="Only consider guests from this list of VMIDs.")
...
class PutClusterCephFlagsRequest(ProxmoxBaseModel):
    ...
    nodeep_scrub: bool | None = Field(
        None, alias="nodeep-scrub", description="Deep Scrubbing is disabled."
    )
    nodown: bool | None = Field(
        None,
        description="OSD failure reports are being ignored, such that the monitors will not mark OSDs down.",
    )
    noin: bool | None = Field(
        None,
        description="OSDs that were previously marked out will not be marked back in when they start.",
    )
    noout: bool | None = Field(
        None, description="OSDs will not automatically be marked out after the configured interval."
    )
...
class PostClusterConfigNodesNodeRequest(ProxmoxBaseModel):
    ...
    new_node_ip: str | None = Field(
        None, description="IP Address of node to add. Used as fallback if no links are given."
    )
    nodeid: int | None = Field(None, description="Node id for this node.")
    votes: int | None = Field(None, description="Number of votes for this node")
...
class GetClusterFirewallGroupsGroupResponseItem(ProxmoxBaseModel):
    action: str | None = Field(
        None, description="Rule action ('ACCEPT', 'DROP', 'REJECT') or security group name"
    )
...
class GetClusterFirewallGroupsGroupResponse(
    RootModel[list[GetClusterFirewallGroupsGroupResponseItem]]
):
...
class PutClusterFirewallGroupsGroupPosRequest(ProxmoxBaseModel):
    ...
    log: str | None = Field(None, description="Log level for firewall rule.")
    macro: str | None = Field(None, description="Use predefined standard macro.")
    moveto: int | None = Field(
        None, description="Move rule to new position <moveto>. Other arguments are ignored."
    )
    proto: str | None = Field(
        None,
        description="IP protocol. You can use protocol names ('tcp'/'udp') or simple numbers, as defined in '/etc/protocols'.",
...
class DeleteClusterFirewallIpsetNameRequest(ProxmoxBaseModel):
    force: bool | None = Field(
        None, description="Delete all members of the IPSet, if there are any."
    )
...
class PutClusterHaGroupsGroupRequest(ProxmoxBaseModel):
    ...
    nodes: str | None = Field(
        None, description="List of cluster node names with optional priority."
    )
    nofailback: bool | None = Field(
        None,
        description="The CRM tries to run services on the node with the highest priority. If a node with higher priority comes online, the CRM migrates the service to that node. Enabling nofailback prevents that behavior.",
...
class PostClusterHaResourcesRequest(ProxmoxBaseModel):
    ...
    max_relocate: int | None = Field(
        None, description="Maximal number of service relocate tries when a service failes to start."
    )
    max_restart: int | None = Field(
        None,
...
class PostClusterHaResourcesSidMigrateResponse(ProxmoxBaseModel):
    blocking_resources: list[dict[str, object]] | None = Field(
        None,
        alias="blocking-resources",
        description="HA resources, which are blocking the given HA resource from being migrated to the requested target node.",
    )
    comigrated_resources: list[object] | None = Field(
        None,
        alias="comigrated-resources",
    ...
    requested_node: str = Field(
        ..., alias="requested-node", description="Node, which was requested to be migrated to."
    )
...
class PostClusterHaResourcesSidRelocateResponse(ProxmoxBaseModel):
    ...
    comigrated_resources: list[str] | None = Field(
        None,
        alias="comigrated-resources",
    ...
    requested_node: str = Field(
        ..., alias="requested-node", description="Node, which was requested to be relocated to."
    )
...
class PostClusterHaRulesRequest(ProxmoxBaseModel):
    ...
    strict: bool | None = Field(
        None, description="Describes whether the node affinity rule is strict or non-strict."
    )
...
class GetClusterHaStatusCurrentResponseItem(ProxmoxBaseModel):
    crm_state: str | None = Field(
        None, description="For type 'service'. Service state as seen by the CRM."
    )
    failback: bool | None = Field(
        None,
        description="The HA resource is automatically migrated to the node with the highest priority according to their node affinity rule, if a node with a higher priority than the current node comes online.",
    ...
    id: str | None = Field(
        None, description="Status entry ID (quorum, master, lrm:<node>, service:<sid>)."
    )
    ...
    quorate: bool | None = Field(
        None, description="For type 'quorum'. Whether the cluster is quorate or not."
    )
    request_state: str | None = Field(
        None, description="For type 'service'. Requested service state."
    )
    ...
    timestamp: int | None = Field(
        None, description="For type 'lrm','master'. Timestamp of the status information."
    )
...
class GetClusterJobsScheduleAnalyzeResponse(
    RootModel[list[GetClusterJobsScheduleAnalyzeResponseItem]]
):
    root: list[GetClusterJobsScheduleAnalyzeResponseItem] = Field(
...
class GetClusterMappingDirResponseItem(ProxmoxBaseModel):
    checks: list[dict[str, object]] | None = Field(
        None, description="A list of checks, only present if 'check-node' is set."
    )
...
class GetClusterMappingPciResponseItem(ProxmoxBaseModel):
    checks: list[dict[str, object]] | None = Field(
        None, description="A list of checks, only present if 'check_node' is set."
    )
    description: str | None = Field(None, description="A description of the logical mapping.")
    id: str | None = Field(None, description="The logical ID of the mapping.")
    map: list[str] | None = Field(None, description="The entries of the mapping.")
...
class PostClusterMappingPciRequest(ProxmoxBaseModel):
    ...
    live_migration_capable: bool | None = Field(
        None,
        alias="live-migration-capable",
    ...
    map: list[str] = Field(..., description="A list of maps for the cluster nodes.")
    mdev: bool | None = Field(
        None, description="Marks the device(s) as being capable of providing mediated devices."
    )
...
class PostClusterMetricsServerIdRequest(ProxmoxBaseModel):
    ...
    bucket: str | None = Field(
        None, description="The InfluxDB bucket/db. Only necessary when using the http v2 api."
    )
    disable: bool | None = Field(None, description="Flag to disable the plugin.")
    ...
    otel_compression: str | None = Field(
        None, alias="otel-compression", description="Compression algorithm for requests"
    )
    otel_headers: str | None = Field(
        None, alias="otel-headers", description="Custom HTTP headers (JSON format, base64 encoded)"
    )
    otel_max_body_size: int | None = Field(
        None, alias="otel-max-body-size", description="Maximum request body size in bytes"
    )
    ...
    otel_resource_attributes: str | None = Field(
        None,
        alias="otel-resource-attributes",
        description="Additional resource attributes as JSON, base64 encoded",
    )
    otel_timeout: int | None = Field(
        None, alias="otel-timeout", description="HTTP request timeout in seconds"
    )
    otel_verify_ssl: bool | None = Field(
        None, alias="otel-verify-ssl", description="Verify SSL certificates"
    )
    ...
    proto: str | None = Field(
        None, description="Protocol to send graphite data. TCP or UDP (default)"
    )
    ...
    verify_certificate: bool | None = Field(
        None,
...
class GetClusterNotificationsEndpointsGotifyResponseItem(ProxmoxBaseModel):
    ...
    origin: str | None = Field(
        None, description="Show if this entry was created by a user or was built-in"
    )
    server: str | None = Field(None, description="Server URL")


class GetClusterNotificationsEndpointsGotifyResponse(
    RootModel[list[GetClusterNotificationsEndpointsGotifyResponseItem]]
):
...
class GetClusterNotificationsEndpointsSendmailResponseItem(ProxmoxBaseModel):
    ...
    from_address: str | None = Field(
        None, alias="from-address", description="`From` address for the mail"
    )
...
class GetClusterNotificationsEndpointsSendmailResponse(
    RootModel[list[GetClusterNotificationsEndpointsSendmailResponseItem]]
):
...
class GetClusterNotificationsEndpointsSmtpResponseItem(ProxmoxBaseModel):
    ...
    mailto_user: list[str] | None = Field(None, alias="mailto-user", description="List of users")
    mode: str | None = Field(
        None, description="Determine which encryption method shall be used for the connection."
    )
    name: str | None = Field(None, description="The name of the endpoint.")
    origin: str | None = Field(
        None, description="Show if this entry was created by a user or was built-in"
...
class GetClusterNotificationsEndpointsSmtpResponse(
    RootModel[list[GetClusterNotificationsEndpointsSmtpResponseItem]]
):
...
class GetClusterNotificationsEndpointsWebhookResponse(
    RootModel[list[GetClusterNotificationsEndpointsWebhookResponseItem]]
):
...
class GetClusterNotificationsMatcherFieldValuesResponse(
    RootModel[list[GetClusterNotificationsMatcherFieldValuesResponseItem]]
):
...
class GetClusterNotificationsMatcherFieldsResponse(
    RootModel[list[GetClusterNotificationsMatcherFieldsResponseItem]]
):
...
class GetClusterNotificationsMatchersResponseItem(ProxmoxBaseModel):
    ...
    invert_match: bool | None = Field(
        None, alias="invert-match", description="Invert match of the whole matcher"
    )
    match_calendar: list[str] | None = Field(
        None, alias="match-calendar", description="Match notification timestamp"
    )
    match_field: list[str] | None = Field(
        None,
        alias="match-field",
        description="Metadata fields to match (regex or exact match). Must be in the form (regex|exact):<field>=<value>",
    )
    match_severity: list[str] | None = Field(
        None, alias="match-severity", description="Notification severities to match"
    )
    mode: str | None = Field(
        None,
...
class GetClusterNotificationsMatchersResponse(
    RootModel[list[GetClusterNotificationsMatchersResponseItem]]
):
...
class GetClusterNotificationsTargetsResponse(
    RootModel[list[GetClusterNotificationsTargetsResponseItem]]
):
...
class PutClusterOptionsRequest(ProxmoxBaseModel):
    bwlimit: str | None = Field(
        None, description="Set I/O bandwidth limit for various operations (in KiB/s)."
    )
    consent_text: str | None = Field(
        None, alias="consent-text", description="Consent text that is displayed before logging in."
    )
    ...
    migration_unsecure: bool | None = Field(
        None,
    ...
    user_tag_access: str | None = Field(
        None, alias="user-tag-access", description="Privilege options for user-settable tags"
    )
...
class GetClusterReplicationResponseItem(ProxmoxBaseModel):
    ...
    rate: float | None = Field(
        None, description="Rate limit in mbps (megabytes per second) as floating point number."
    )
    remove_job: str | None = Field(
        None,
    ...
    source: str | None = Field(
        None, description="For internal use, to detect if the guest was stolen."
    )
...
class DeleteClusterReplicationIdRequest(ProxmoxBaseModel):
    force: bool | None = Field(
        None, description="Will remove the jobconfig entry, but will not cleanup."
    )
...
class GetClusterResourcesResponseItem(ProxmoxBaseModel):
    ...
    lock: str | None = Field(
        None, description="The guest's current config lock (for types 'qemu' and 'lxc')"
    )
    maxcpu: float | None = Field(
        None, description="Number of available CPUs (for types 'node', 'qemu' and 'lxc')."
    )
    maxdisk: int | None = Field(
        None,
    ...
    mem: int | None = Field(
        None, description="Used memory in bytes (for types 'node', 'qemu' and 'lxc')."
    )
    memhost: int | None = Field(
        None,
    ...
    network: str | None = Field(
        None, description="The name of a Network entity (for type 'network')."
    )
    network_type: str | None = Field(
        None, alias="network-type", description="The type of network resource (for type 'network')."
    )
    node: str | None = Field(
        None, description="The cluster node name (for types 'node', 'storage', 'qemu', and 'lxc')."
    )
    plugintype: str | None = Field(None, description="More specific type, if available.")
    pool: str | None = Field(
        None, description="The pool name (for types 'pool', 'qemu' and 'lxc')."
    )
    protocol: str | None = Field(
        None, description="The protocol of a fabric (for type 'network', network-type 'fabric')."
    )
    ...
    template: bool | None = Field(
        None, description="Determines if the guest is a template. (for types 'qemu' and 'lxc')"
    )
    type: str | None = Field(None, description="Resource type.")
    ...
    zone_type: str | None = Field(
        None, alias="zone-type", description="The type of an SDN zone (for type 'sdn')."
    )
...
class PutClusterSdnRequest(ProxmoxBaseModel):
    lock_token: str | None = Field(
        None, alias="lock-token", description="the token for unlocking the global SDN configuration"
    )
    release_lock: bool | None = Field(
        None,
        alias="release-lock",
...
class GetClusterSdnControllersResponseItem(ProxmoxBaseModel):
    ...
    bgp_multipath_as_relax: bool | None = Field(
        None,
    ...
    isis_domain: str | None = Field(
        None, alias="isis-domain", description="Name of the IS-IS domain. IS-IS only."
    )
    isis_ifaces: str | None = Field(
        None,
        alias="isis-ifaces",
        description="Comma-separated list of interfaces where IS-IS should be active. IS-IS only.",
    )
    isis_net: str | None = Field(
        None,
        alias="isis-net",
    ...
    pending: dict[str, object] | None = Field(
        None, description="Changes that have not yet been applied to the running configuration."
    )
...
class PostClusterSdnControllersRequest(ProxmoxBaseModel):
    ...
    bgp_multipath_as_path_relax: bool | None = Field(
        None,
        alias="bgp-multipath-as-path-relax",
    ...
    ebgp_multihop: int | None = Field(
        None, alias="ebgp-multihop", description="Set maximum amount of hops for eBGP peers."
    )
    fabric: str | None = Field(
        None, description="SDN fabric to use as underlay for this EVPN controller."
    )
    isis_domain: str | None = Field(
        None, alias="isis-domain", description="Name of the IS-IS domain."
    )
    isis_ifaces: str | None = Field(
        None,
        alias="isis-ifaces",
    ...
    loopback: str | None = Field(
        None, description="Name of the loopback/dummy interface that provides the Router-IP."
    )
...
class GetClusterSdnFabricsFabricResponseItem(ProxmoxBaseModel):
    ...
    csnp_interval: float | None = Field(
        None, description="The csnp_interval property for Openfabric"
    )
    digest: str | None = Field(
        None,
        description="Prevent changes if current configuration file has a different digest. This can be used to prevent concurrent modifications.",
    )
    hello_interval: float | None = Field(
        None, description="The hello_interval property for Openfabric"
    )
    ...
    protocol: str | None = Field(
        None, description="Type of configuration entry in an SDN Fabric section config"
    )
...
class GetClusterSdnFabricsNodeFabricIdResponse(
    RootModel[list[GetClusterSdnFabricsNodeFabricIdResponseItem]]
):
...
class DeleteClusterSdnLockRequest(ProxmoxBaseModel):
    force: bool | None = Field(
        None, description="if true, allow releasing lock without providing the token"
    )
    lock_token: str | None = Field(
        None, alias="lock-token", description="the token for unlocking the global SDN configuration"
    )
...
class GetClusterSdnVnetsVnetFirewallRulesResponse(
    RootModel[list[GetClusterSdnVnetsVnetFirewallRulesResponseItem]]
):
...
class PostClusterSdnVnetsVnetSubnetsRequest(ProxmoxBaseModel):
    dhcp_dns_server: str | None = Field(
        None, alias="dhcp-dns-server", description="IP address for the DNS server"
    )
    dhcp_range: list[str] | None = Field(
        None, alias="dhcp-range", description="A list of DHCP ranges for this subnet"
    )
    dnszoneprefix: str | None = Field(
        None, description="dns domain zone prefix  ex: 'adm' -> <hostname>.adm.mydomain.com"
    )
    gateway: str | None = Field(
        None, description="Subnet Gateway: Will be assign on vnet for layer3 zones"
    )
    lock_token: str | None = Field(
        None, alias="lock-token", description="the token for unlocking the global SDN configuration"
    )
...
class GetClusterSdnZonesResponseItem(ProxmoxBaseModel):
    advertise_subnets: bool | None = Field(
        None,
    ...
    bridge: str | None = Field(
        None, description="the bridge for which VLANs should be managed. VLAN & QinQ zone only."
    )
    bridge_disable_mac_learning: bool | None = Field(
        None,
        alias="bridge-disable-mac-learning",
        description="Disable auto mac learning. VLAN zone only.",
    )
    controller: str | None = Field(
        None, description="ID of the controller for this zone. EVPN zone only."
    )
    dhcp: str | None = Field(None, description="Name of DHCP server backend for this zone.")
    digest: str | None = Field(None, description="Digest of the controller section.")
    disable_arp_nd_suppression: bool | None = Field(
        None,
    ...
    exitnodes_primary: str | None = Field(
        None,
    ...
    mtu: int | None = Field(
        None, description="MTU of the zone, will be used for the created VNet bridges."
    )
    ...
    vlan_protocol: str | None = Field(
        None,
        alias="vlan-protocol",
        description="VLAN protocol for the creation of the QinQ zone. QinQ zone only.",
    )
    vrf_vxlan: int | None = Field(
        None, alias="vrf-vxlan", description="VNI for the zone VRF. EVPN zone only."
    )
    vxlan_port: int | None = Field(
        None,
        alias="vxlan-port",
...
class PostClusterSdnZonesRequest(ProxmoxBaseModel):
    ...
    bridge_disable_mac_learning: bool | None = Field(
        None, alias="bridge-disable-mac-learning", description="Disable auto mac learning."
    )
    ...
    exitnodes_primary: str | None = Field(
        None, alias="exitnodes-primary", description="Force traffic through this exitnode first."
    )
    fabric: str | None = Field(
        None, description="SDN fabric to use as underlay for this VXLAN zone."
    )
...
class GetClusterStatusResponseItem(ProxmoxBaseModel):
    ...
    nodeid: int | None = Field(
        None, description="[node] ID of the node from the corosync configuration."
    )
    nodes: int | None = Field(None, description="[cluster] Nodes count, including offline nodes.")
    online: bool | None = Field(
        None, description="[node] Indicates if the node is online or offline."
    )
    quorate: bool | None = Field(
        None,
    ...
    version: int | None = Field(
        None, description="[cluster] Current version of the corosync configuration file."
    )
...
class GetNodesResponseItem(ProxmoxBaseModel):
    ...
    node: str | None = Field(None, description="The cluster node name.")
    ssl_fingerprint: str | None = Field(
        None, description="The SSL fingerprint for the node certificate."
    )
...
class GetNodesNodeAptRepositoriesResponse(ProxmoxBaseModel):
    ...
    infos: list[dict[str, object]] = Field(
        ..., description="Additional information/warnings for APT repositories."
    )
    standard_repos: list[dict[str, object]] = Field(
        ...,
        alias="standard-repos",
...
class PostNodesNodeAptRepositoriesRequest(ProxmoxBaseModel):
    ...
    enabled: bool | None = Field(
        None, description="Whether the repository should be enabled or not."
    )
...
class GetNodesNodeAptUpdateResponseItem(ProxmoxBaseModel):
    ...
    notify_status: str | None = Field(
        None,
        alias="NotifyStatus",
        description="Version for which PVE has already sent an update notification for.",
    )
    old_version: str | None = Field(
        None, alias="OldVersion", description="Old version currently installed."
    )
    origin: str | None = Field(
        None, alias="Origin", description="Package origin, e.g., 'Proxmox' or 'Debian'."
    )
...
class PostNodesNodeAptUpdateRequest(ProxmoxBaseModel):
    ...
    quiet: bool | None = Field(
        None, description="Only produces output suitable for logging, omitting progress indicators."
    )
...
class GetNodesNodeAptVersionsResponseItem(ProxmoxBaseModel):
    ...
    description: str | None = Field(None, alias="Description", description="Package description.")
    manager_version: str | None = Field(
        None,
    ...
    package: str | None = Field(None, alias="Package", description="Package name.")
    priority: str | None = Field(None, alias="Priority", description="Package priority.")
    running_kernel: str | None = Field(
        None, alias="RunningKernel", description="Kernel release, only for package 'proxmox-ve'."
    )
    section: str | None = Field(None, alias="Section", description="Package section.")
    title: str | None = Field(None, alias="Title", description="Package title.")
    version: str | None = Field(None, alias="Version", description="New version to be updated to.")
...
class GetNodesNodeCapabilitiesQemuCpuResponse(
    RootModel[list[GetNodesNodeCapabilitiesQemuCpuResponseItem]]
):
...
class GetNodesNodeCapabilitiesQemuCpuFlagsResponse(
    RootModel[list[GetNodesNodeCapabilitiesQemuCpuFlagsResponseItem]]
):
...
class GetNodesNodeCapabilitiesQemuMachinesResponseItem(ProxmoxBaseModel):
    changes: str | None = Field(
        None, description="Notable changes of a version, currently only set for +pveX versions."
    )
...
class GetNodesNodeCapabilitiesQemuMachinesResponse(
    RootModel[list[GetNodesNodeCapabilitiesQemuMachinesResponseItem]]
):
...
class PostNodesNodeCephInitRequest(ProxmoxBaseModel):
    ...
    disable_cephx: bool | None = Field(
        None,
        description="Disable cephx authentication.\n\nWARNING: cephx is a security feature protecting against man-in-the-middle attacks. Only consider disabling cephx if your network is private!",
    )
    min_size: int | None = Field(
        None, description="Minimum number of available replicas per object to allow I/O"
    )
    network: str | None = Field(
        None, description="Use specific network for all ceph related traffic"
    )
    pg_bits: int | None = Field(
        None,
...
class GetNodesNodeCephMdsResponseItem(ProxmoxBaseModel):
    ...
    standby_replay: bool | None = Field(
        None,
...
class PostNodesNodeCephOsdRequest(ProxmoxBaseModel):
    crush_device_class: str | None = Field(
        None, alias="crush-device-class", description="Set the device class of the OSD in crush."
    )
    ...
    osds_per_device: int | None = Field(
        None,
        alias="osds-per-device",
...
class PostNodesNodeCephOsdOsdidScrubRequest(ProxmoxBaseModel):
    deep: bool | None = Field(
        None, description="If set, instructs a deep scrub instead of a normal one."
    )
...
class PostNodesNodeCephPoolRequest(ProxmoxBaseModel):
    add_storages: bool | None = Field(
        None, description="Configure VM and CT storage using the new pool."
    )
    application: str | None = Field(None, description="The application of the pool.")
    crush_rule: str | None = Field(
        None, description="The rule to use for mapping object placement in the cluster."
    )
    ...
    pg_autoscale_mode: str | None = Field(
        None, description="The automatic PG scaling mode of the pool."
    )
    ...
    target_size: str | None = Field(
        None, description="The estimated target size of the pool for the PG autoscaler."
    )
    target_size_ratio: float | None = Field(
        None, description="The estimated target ratio of the pool for the PG autoscaler."
    )
...
class DeleteNodesNodeCephPoolNameRequest(ProxmoxBaseModel):
    ...
    remove_ecprofile: bool | None = Field(
        None, description="Remove the erasure code profile. Defaults to true, if applicable."
    )
    remove_storages: bool | None = Field(
        None, description="Remove all pveceph-managed storages configured for this pool"
    )
...
class PutNodesNodeCertificatesAcmeCertificateRequest(ProxmoxBaseModel):
    force: bool | None = Field(
        None, description="Force renewal even if expiry is more than 30 days away."
    )
...
class PostNodesNodeCertificatesCustomRequest(ProxmoxBaseModel):
    ...
    force: bool | None = Field(
        None, description="Overwrite existing custom or ACME certificate files."
    )
...
class PostNodesNodeCertificatesCustomResponse(ProxmoxBaseModel):
    ...
    notbefore: int | None = Field(
        None, description="Certificate's notBefore timestamp (UNIX epoch)."
    )
    pem: str | None = Field(None, description="Certificate in PEM format")
    public_key_bits: int | None = Field(
        None, alias="public-key-bits", description="Certificate's public key size"
    )
    public_key_type: str | None = Field(
        None, alias="public-key-type", description="Certificate's public key algorithm"
    )
    san: list[str] | None = Field(
        None, description="List of Certificate's SubjectAlternativeName entries."
    )
...
class GetNodesNodeCertificatesInfoResponse(
    RootModel[list[GetNodesNodeCertificatesInfoResponseItem]]
):
...
class GetNodesNodeConfigResponse(ProxmoxBaseModel):
    ...
    acmedomain_n: str | None = Field(
        None, alias="acmedomain[n]", description="ACME domain and validation plugin"
    )
    ballooning_target: int | None = Field(
        None,
    ...
    startall_onboot_delay: int | None = Field(
        None,
...
class DeleteNodesNodeDisksDirectoryNameRequest(ProxmoxBaseModel):
    cleanup_config: bool | None = Field(
        None,
        alias="cleanup-config",
...
class GetNodesNodeDisksZfsNameResponse(ProxmoxBaseModel):
    action: str | None = Field(
        None, description="Information about the recommended action to fix the state."
    )
    children: list[dict[str, object]] = Field(
        ...,
...
class GetNodesNodeFirewallOptionsResponse(ProxmoxBaseModel):
    ...
    log_nf_conntrack: bool | None = Field(
        None, description="Enable logging of conntrack information."
    )
    ndp: bool | None = Field(None, description="Enable NDP (Neighbor Discovery Protocol).")
    nf_conntrack_allow_invalid: bool | None = Field(
        None, description="Allow invalid packets on connection tracking."
    )
    ...
    nf_conntrack_tcp_timeout_established: int | None = Field(
        None, description="Conntrack established timeout."
    )
    nf_conntrack_tcp_timeout_syn_recv: int | None = Field(
        None, description="Conntrack syn recv timeout."
    )
    ...
    protection_synflood_burst: int | None = Field(
        None, description="Synflood protection rate burst by ip src."
    )
    protection_synflood_rate: int | None = Field(
        None, description="Synflood protection rate syn/sec by ip src."
    )
    smurf_log_level: str | None = Field(None, description="Log level for SMURFS filter.")
    tcp_flags_log_level: str | None = Field(
        None, description="Log level for illegal tcp flags filter."
    )
...
class GetNodesNodeHardwarePciResponseItem(ProxmoxBaseModel):
    ...
    iommugroup: int | None = Field(
        None,
        description="The IOMMU group in which the device is in. If no IOMMU group is detected, it is set to -1.",
    )
    mdev: bool | None = Field(
        None, description="If set, marks that the device is capable of creating mediated devices."
    )
...
class GetNodesNodeHardwarePciPciIdOrMappingResponse(
    RootModel[list[GetNodesNodeHardwarePciPciIdOrMappingResponseItem]]
):
...
class GetNodesNodeHardwarePciPciIdOrMappingMdevResponseItem(ProxmoxBaseModel):
    available: int | None = Field(
        None, description="The number of still available instances of this type."
    )
...
class GetNodesNodeHardwarePciPciIdOrMappingMdevResponse(
    RootModel[list[GetNodesNodeHardwarePciPciIdOrMappingMdevResponseItem]]
):
...
class GetNodesNodeLxcResponseItem(ProxmoxBaseModel):
    ...
    pressurecpusome: float | None = Field(
        None, description="CPU Some pressure stall average over the last 10 seconds."
    )
    pressureiofull: float | None = Field(
        None, description="IO Full pressure stall average over the last 10 seconds."
    )
    pressureiosome: float | None = Field(
        None, description="IO Some pressure stall average over the last 10 seconds."
    )
    pressurememoryfull: float | None = Field(
        None, description="Memory Full pressure stall average over the last 10 seconds."
    )
    pressurememorysome: float | None = Field(
        None, description="Memory Some pressure stall average over the last 10 seconds."
    )
...
class PostNodesNodeLxcRequest(ProxmoxBaseModel):
    ...
    console: bool | None = Field(
        None, description="Attach a console device (/dev/console) to the container."
    )
    cores: int | None = Field(
        None,
        description="The number of cores assigned to the container. A container can use all available cores by default.",
    )
    cpulimit: float | None = Field(
        None,
        description="Limit of CPU usage.\n\nNOTE: If the computer has 2 CPUs, it has a total of '2' CPU time. Value '0' indicates no CPU limit.",
    )
    cpuunits: int | None = Field(
        None, description="CPU weight for a container, will be clamped to [1, 10000] in cgroup v2."
    )
    ...
    dev_n: str | None = Field(
        None, alias="dev[n]", description="Device to pass through to the container"
    )
    ...
    ha_managed: bool | None = Field(
        None, alias="ha-managed", description="Add the CT as a HA resource after it was created."
    )
    ...
    ignore_unpack_errors: bool | None = Field(
        None,
        alias="ignore-unpack-errors",
    ...
    net_n: str | None = Field(
        None, alias="net[n]", description="Specifies network interfaces for the container."
    )
    onboot: bool | None = Field(
        None, description="Specifies whether a container will be started during system bootup."
    )
    ...
    ssh_public_keys: str | None = Field(
        None,
        alias="ssh-public-keys",
        description="Setup public SSH keys (one key per line, OpenSSH format).",
    )
    start: bool | None = Field(
        None, description="Start the CT after its creation finished successfully."
    )
    ...
    tags: str | None = Field(
        None, description="Tags of the Container. This is only meta information."
    )
    ...
    tty: int | None = Field(
        None, description="Specify the number of tty available to the container"
    )
    unique: bool | None = Field(None, description="Assign a unique random ethernet address.")
    unprivileged: bool | None = Field(
        None,
...
class DeleteNodesNodeLxcVmidRequest(ProxmoxBaseModel):
    destroy_unreferenced_disks: bool | None = Field(
        None,
        alias="destroy-unreferenced-disks",
...
class PostNodesNodeLxcVmidCloneRequest(ProxmoxBaseModel):
    ...
    target: str | None = Field(
        None, description="Target node. Only allowed if the original VM is on shared storage."
    )
...
class GetNodesNodeLxcVmidFirewallAliasesResponse(
    RootModel[list[GetNodesNodeLxcVmidFirewallAliasesResponseItem]]
):
...
class GetNodesNodeLxcVmidFirewallIpsetResponse(
    RootModel[list[GetNodesNodeLxcVmidFirewallIpsetResponseItem]]
):
...
class GetNodesNodeLxcVmidFirewallIpsetNameResponse(
    RootModel[list[GetNodesNodeLxcVmidFirewallIpsetNameResponseItem]]
):
...
class GetNodesNodeLxcVmidFirewallLogResponse(
    RootModel[list[GetNodesNodeLxcVmidFirewallLogResponseItem]]
):
...
class GetNodesNodeLxcVmidFirewallRefsResponse(
    RootModel[list[GetNodesNodeLxcVmidFirewallRefsResponseItem]]
):
...
class GetNodesNodeLxcVmidFirewallRulesResponse(
    RootModel[list[GetNodesNodeLxcVmidFirewallRulesResponseItem]]
):
...
class GetNodesNodeLxcVmidInterfacesResponseItem(ProxmoxBaseModel):
    hardware_address: str | None = Field(
        None, alias="hardware-address", description="The MAC address of the interface"
    )
    ...
    ip_addresses: list[dict[str, object]] | None = Field(
        None, alias="ip-addresses", description="The addresses of the interface"
    )
    name: str | None = Field(None, description="The name of the interface")


class GetNodesNodeLxcVmidInterfacesResponse(
    RootModel[list[GetNodesNodeLxcVmidInterfacesResponseItem]]
):
    root: list[GetNodesNodeLxcVmidInterfacesResponseItem] = Field(...)


class GetNodesNodeLxcVmidMigrateResponse(ProxmoxBaseModel):
    allowed_nodes: list[str] | None = Field(
        None, alias="allowed-nodes", description="List of nodes allowed for migration."
    )
    dependent_ha_resources: list[str] | None = Field(
        None,
        alias="dependent-ha-resources",
    ...
    not_allowed_nodes: dict[str, object] | None = Field(
        None,
        alias="not-allowed-nodes",
...
class PostNodesNodeLxcVmidMigrateRequest(ProxmoxBaseModel):
    ...
    target_storage: str | None = Field(
        None,
        alias="target-storage",
        description="Mapping from source to target storages. Providing only a single storage ID maps all source storages to that storage. Providing the special value '1' will map each source storage to itself.",
    )
    timeout: int | None = Field(
        None, description="Timeout in seconds for shutdown for restart migration"
    )
...
class PostNodesNodeLxcVmidMoveVolumeRequest(ProxmoxBaseModel):
    ...
    target_vmid: int | None = Field(
        None, alias="target-vmid", description="The (unique) ID of the VM."
    )
...
class GetNodesNodeLxcVmidPendingResponseItem(ProxmoxBaseModel):
    delete: int | None = Field(
        None, description="Indicates a pending delete request if present and not 0."
    )
...
class GetNodesNodeLxcVmidSnapshotResponseItem(ProxmoxBaseModel):
    ...
    name: str | None = Field(
        None, description="Snapshot identifier. Value 'current' identifies the current VM."
    )
...
class DeleteNodesNodeLxcVmidSnapshotSnapnameRequest(ProxmoxBaseModel):
    force: bool | None = Field(
        None, description="For removal from config file, even if removing disk snapshots fails."
    )
...
class PostNodesNodeLxcVmidSnapshotSnapnameRollbackRequest(ProxmoxBaseModel):
    start: bool | None = Field(
        None, description="Whether the container should get started after rolling back successfully"
    )
...
class PostNodesNodeLxcVmidStatusShutdownRequest(ProxmoxBaseModel):
    force_stop: bool | None = Field(
        None, alias="forceStop", description="Make sure the Container stops."
    )
...
class PostNodesNodeLxcVmidStatusStartRequest(ProxmoxBaseModel):
    debug: bool | None = Field(
        None, description="If set, enables very verbose debug log-level on start."
    )
    skiplock: bool | None = Field(
        None, description="Ignore locks - only root is allowed to use this option."
    )
...
class PostNodesNodeLxcVmidStatusStopRequest(ProxmoxBaseModel):
    overrule_shutdown: bool | None = Field(
        None,
        alias="overrule-shutdown",
...
class GetNodesNodeNetworkResponseItem(ProxmoxBaseModel):
    ...
    bond_xmit_hash_policy: str | None = Field(
        None,
        description="Selects the transmit hash policy to use for slave selection in balance-xor and 802.3ad modes.",
    )
    bridge_access: int | None = Field(
        None, alias="bridge-access", description="The bridge port access VLAN."
    )
    bridge_arp_nd_suppress: bool | None = Field(
        None, alias="bridge-arp-nd-suppress", description="Bridge port ARP/ND suppress flag."
    )
    bridge_learning: bool | None = Field(
        None, alias="bridge-learning", description="Bridge port learning flag."
    )
    bridge_multicast_flood: bool | None = Field(
        None, alias="bridge-multicast-flood", description="Bridge port multicast flood flag."
    )
    bridge_unicast_flood: bool | None = Field(
        None, alias="bridge-unicast-flood", description="Bridge port unicast flood flag."
    )
    bridge_ports: str | None = Field(
        None, description="Specify the interfaces you want to add to your bridge."
    )
    bridge_vids: str | None = Field(
        None,
    ...
    options: list[str] | None = Field(
        None, description="A list of additional interface options for IPv4."
    )
    options6: list[str] | None = Field(
        None, description="A list of additional interface options for IPv6."
    )
    ovs_bonds: str | None = Field(
        None, description="Specify the interfaces used by the bonding device."
    )
    ...
    ovs_tag: int | None = Field(
        None, description="Specify a VLan tag (used by OVSPort, OVSIntPort, OVSBond)"
    )
    ...
    vxlan_local_tunnelip: str | None = Field(
        None, alias="vxlan-local-tunnelip", description="The VXLAN local tunnel IP."
    )
    vxlan_physdev: str | None = Field(
        None, alias="vxlan-physdev", description="The physical device for the VXLAN tunnel."
    )
    vxlan_svcnodeip: str | None = Field(
        None, alias="vxlan-svcnodeip", description="The VXLAN SVC node IP."
    )
...
class PutNodesNodeNetworkRequest(ProxmoxBaseModel):
    regenerate_frr: bool | None = Field(
        None,
        alias="regenerate-frr",
...
class GetNodesNodeQemuResponseItem(ProxmoxBaseModel):
    ...
    pressurecpufull: float | None = Field(
        None, description="CPU Full pressure stall average over the last 10 seconds."
    )
    pressurecpusome: float | None = Field(
        None, description="CPU Some pressure stall average over the last 10 seconds."
    )
    ...
    qmpstatus: str | None = Field(
        None, description="VM run state from the 'query-status' QMP monitor command."
    )
    running_machine: str | None = Field(
        None,
        alias="running-machine",
        description="The currently running machine type (if running).",
    )
    running_qemu: str | None = Field(
        None,
        alias="running-qemu",
...
class PostNodesNodeQemuRequest(ProxmoxBaseModel):
    ...
    audio0: str | None = Field(
        None, description="Configure a audio device, useful in combination with QXL/Spice."
    )
    autostart: bool | None = Field(
        None, description="Automatic restart after crash (currently ignored)."
    )
    balloon: int | None = Field(
        None,
    ...
    citype: str | None = Field(
        None,
        description="Specifies the cloud-init configuration format. The default depends on the configured operating system type (`ostype`. We use the `nocloud` format for Linux, and `configdrive2` for windows.",
    )
    ciupgrade: bool | None = Field(
        None, description="cloud-init: do an automatic package upgrade after the first boot."
    )
    ...
    cpuunits: int | None = Field(
        None, description="CPU weight for a VM, will be clamped to [1, 10000] in cgroup v2."
    )
    description: str | None = Field(
        None,
    ...
    freeze: bool | None = Field(
        None, description="Freeze CPU at startup (use 'c' monitor command to start execution)."
    )
    ha_managed: bool | None = Field(
        None, alias="ha-managed", description="Add the VM as a HA resource after it was created."
    )
    hookscript: str | None = Field(
        None, description="Script that will be executed during various steps in the vms lifetime."
    )
    hostpci_n: str | None = Field(
        None, alias="hostpci[n]", description="Map host PCI devices into guest."
    )
    ...
    import_working_storage: str | None = Field(
        None,
        alias="import-working-storage",
    ...
    intel_tdx: str | None = Field(
        None, alias="intel-tdx", description="Trusted Domain Extension (TDX) features by Intel CPUs"
    )
    ipconfig_n: str | None = Field(
        None,
        alias="ipconfig[n]",
    ...
    migrate_downtime: float | None = Field(
        None,
    ...
    migrate_speed: int | None = Field(
        None, description="Set maximum speed (in MB/s) for migrations. Value 0 is no limit."
    )
    name: str | None = Field(
        None, description="Set a name for the VM. Only used on the configuration web interface."
    )
    nameserver: str | None = Field(
        None,
    ...
    onboot: bool | None = Field(
        None, description="Specifies whether a VM will be started during system bootup."
    )
    ostype: str | None = Field(None, description="Specify guest operating system.")
    parallel_n: str | None = Field(
        None, alias="parallel[n]", description="Map host parallel devices (n is 0 to 2)."
    )
    pool: str | None = Field(None, description="Add the VM to the specified pool.")
    protection: bool | None = Field(
        None,
    ...
    reboot: bool | None = Field(
        None, description="Allow reboot. If set to '0' the VM exit on reboot."
    )
    rng0: str | None = Field(None, description="Configure a VirtIO-based Random Number Generator.")
    sata_n: str | None = Field(
        None,
        alias="sata[n]",
    ...
    serial_n: str | None = Field(
        None, alias="serial[n]", description="Create a serial device inside the VM (n is 0 to 3)"
    )
    ...
    smp: int | None = Field(
        None, description="The number of CPUs. Please use option -sockets instead."
    )
    sockets: int | None = Field(None, description="The number of CPU sockets.")
    spice_enhancements: str | None = Field(
        None, description="Configure additional enhancements for SPICE."
    )
    sshkeys: str | None = Field(
        None, description="cloud-init: Setup public SSH keys (one key per line, OpenSSH format)."
    )
    ...
    vmstatestorage: str | None = Field(
        None, description="Default storage for VM state volumes/files."
    )
...
class DeleteNodesNodeQemuVmidRequest(ProxmoxBaseModel):
    ...
    purge: bool | None = Field(
        None, description="Remove VMID from configurations, like backup & replication jobs and HA."
    )
    skiplock: bool | None = Field(
        None, description="Ignore locks - only root is allowed to use this option."
    )
...
class GetNodesNodeQemuVmidAgentExecStatusResponse(ProxmoxBaseModel):
    ...
    err_truncated: bool | None = Field(
        None, alias="err-truncated", description="true if stderr was not fully captured"
    )
    exitcode: int | None = Field(
        None, description="process exit code if it was normally terminated."
    )
    ...
    out_truncated: bool | None = Field(
        None, alias="out-truncated", description="true if stdout was not fully captured"
    )
...
class GetNodesNodeQemuVmidAgentFileReadResponse(ProxmoxBaseModel):
    ...
    truncated: bool | None = Field(
        None, description="If set to 1, the output is truncated and not complete"
    )


class PostNodesNodeQemuVmidAgentFileWriteRequest(ProxmoxBaseModel):
    content: str = Field(..., description="The content to write into the file.")
    encode: bool | None = Field(
        None,
...
class PostNodesNodeQemuVmidAgentSetUserPasswordRequest(ProxmoxBaseModel):
    crypted: bool | None = Field(
        None, description="set to 1 if the password has already been passed through crypt()"
    )
    password: str = Field(..., description="The new password.")
...
class PostNodesNodeQemuVmidCloneRequest(ProxmoxBaseModel):
    ...
    format: str | None = Field(
        None, description="Target format for file storage. Only valid for full clone."
    )
    full: bool | None = Field(
        None,
...
class GetNodesNodeQemuVmidCloudinitResponseItem(ProxmoxBaseModel):
    ...
    value: str | None = Field(
        None, description="Value as it was used to generate the current cloudinit image."
    )


class GetNodesNodeQemuVmidCloudinitResponse(
    RootModel[list[GetNodesNodeQemuVmidCloudinitResponseItem]]
):
...
class GetNodesNodeQemuVmidConfigResponse(ProxmoxBaseModel):
    ...
    ide_n: str | None = Field(
        None, alias="ide[n]", description="Use volume as IDE hard disk or CD-ROM (n is 0 to 3)."
    )
    intel_tdx: str | None = Field(
        None, alias="intel-tdx", description="Trusted Domain Extension (TDX) features by Intel CPUs"
    )
    ...
    memory: str | None = Field(None, description="Memory properties.")
    meta: str | None = Field(
        None, description="Some (read-only) meta-information about this guest."
    )
    migrate_downtime: float | None = Field(
        None,
        description="Set maximum tolerated downtime (in seconds) for migrations. Should the migration not be able to converge in the very end, because too much newly dirtied RAM needs to be transferred, the limit will be increased automatically step-by-step until migration can converge.",
    ...
    rng0: str | None = Field(None, description="Configure a VirtIO-based Random Number Generator.")
    running_nets_host_mtu: str | None = Field(
        None,
    ...
    runningcpu: str | None = Field(
        None,
        description="Specifies the QEMU '-cpu' parameter of the running vm. This is used internally for snapshots.",
    )
    runningmachine: str | None = Field(
        None,
        description="Specifies the QEMU machine type of the running vm. This is used internally for snapshots.",
    )
    sata_n: str | None = Field(
        None, alias="sata[n]", description="Use volume as SATA hard disk or CD-ROM (n is 0 to 5)."
    )
    scsi_n: str | None = Field(
        None, alias="scsi[n]", description="Use volume as SCSI hard disk or CD-ROM (n is 0 to 30)."
    )
    scsihw: str | None = Field(None, description="SCSI controller model")
    searchdomain: str | None = Field(
        None,
    ...
    template: bool | None = Field(None, description="Enable/disable Template.")
    tpmstate0: str | None = Field(
        None, description="Configure a Disk for storing TPM state. The format is fixed to 'raw'."
    )
    unused_n: str | None = Field(
        None,
        alias="unused[n]",
    ...
    vga: str | None = Field(None, description="Configure the VGA hardware.")
    virtio_n: str | None = Field(
        None, alias="virtio[n]", description="Use volume as VIRTIO hard disk (n is 0 to 15)."
    )
    virtiofs_n: str | None = Field(
        None,
        alias="virtiofs[n]",
...
class PostNodesNodeQemuVmidConfigRequest(ProxmoxBaseModel):
    ...
    background_delay: int | None = Field(
        None,
...
class GetNodesNodeQemuVmidFirewallAliasesResponse(
    RootModel[list[GetNodesNodeQemuVmidFirewallAliasesResponseItem]]
):
...
class GetNodesNodeQemuVmidFirewallIpsetResponse(
    RootModel[list[GetNodesNodeQemuVmidFirewallIpsetResponseItem]]
):
...
class GetNodesNodeQemuVmidFirewallIpsetNameResponse(
    RootModel[list[GetNodesNodeQemuVmidFirewallIpsetNameResponseItem]]
):
...
class GetNodesNodeQemuVmidFirewallLogResponse(
    RootModel[list[GetNodesNodeQemuVmidFirewallLogResponseItem]]
):
...
class GetNodesNodeQemuVmidFirewallRefsResponse(
    RootModel[list[GetNodesNodeQemuVmidFirewallRefsResponseItem]]
):
...
class GetNodesNodeQemuVmidFirewallRulesResponse(
    RootModel[list[GetNodesNodeQemuVmidFirewallRulesResponseItem]]
):
...
class GetNodesNodeQemuVmidMigrateResponse(ProxmoxBaseModel):
    allowed_nodes: list[str] | None = Field(
        None, description="List of nodes allowed for migration."
    )
    dependent_ha_resources: list[str] | None = Field(
        None,
        alias="dependent-ha-resources",
    ...
    local_disks: list[dict[str, object]] = Field(
    ...
    mapped_resource_info: dict[str, object] = Field(
        ...,
...
class PostNodesNodeQemuVmidMigrateRequest(ProxmoxBaseModel):
    ...
    migration_network: str | None = Field(
        None, description="CIDR of the (sub) network that is used for migration."
    )
    migration_type: str | None = Field(
        None,
    ...
    online: bool | None = Field(
        None, description="Use online/live migration if VM is running. Ignored if VM is stopped."
    )
    target: str = Field(..., description="Target node.")
    ...
    with_conntrack_state: bool | None = Field(
        None,
        alias="with-conntrack-state",
...
class GetNodesNodeQemuVmidSnapshotResponse(
    RootModel[list[GetNodesNodeQemuVmidSnapshotResponseItem]]
):
...
class PostNodesNodeQemuVmidStatusShutdownRequest(ProxmoxBaseModel):
    ...
    keep_active: bool | None = Field(
        None, alias="keepActive", description="Do not deactivate storage volumes."
    )
    skiplock: bool | None = Field(
        None, description="Ignore locks - only root is allowed to use this option."
    )
...
class PostNodesNodeQemuVmidStatusStartRequest(ProxmoxBaseModel):
    force_cpu: str | None = Field(
        None, alias="force-cpu", description="Override QEMU's -cpu argument with the given string."
    )
    machine: str | None = Field(None, description="Specify the QEMU machine.")
    ...
    stateuri: str | None = Field(
        None, description="Some command save/restore state from this location."
    )
    targetstorage: str | None = Field(
        None,
        description="Mapping from source to target storages. Providing only a single storage ID maps all source storages to that storage. Providing the special value '1' will map each source storage to itself.",
...
class PostNodesNodeQemuVmidStatusSuspendRequest(ProxmoxBaseModel):
    ...
    statestorage: str | None = Field(None, description="The storage for the VM state")
    todisk: bool | None = Field(
        None, description="If set, suspends the VM to disk. Will be resumed on next VM start."
    )
...
class PostNodesNodeQemuVmidVncproxyRequest(ProxmoxBaseModel):
    generate_password: bool | None = Field(
        None,
...
class GetNodesNodeReplicationIdLogResponse(
    RootModel[list[GetNodesNodeReplicationIdLogResponseItem]]
):
...
class GetNodesNodeSdnFabricsFabricResponse(
    RootModel[list[GetNodesNodeSdnFabricsFabricResponseItem]]
):
...
class GetNodesNodeSdnFabricsFabricInterfacesResponse(
    RootModel[list[GetNodesNodeSdnFabricsFabricInterfacesResponseItem]]
):
...
class GetNodesNodeSdnFabricsFabricNeighborsResponseItem(ProxmoxBaseModel):
    ...
    uptime: str | None = Field(
        None, description="The uptime of this neighbor, as returned by FRR (e.g. 8h24m12s)."
    )


class GetNodesNodeSdnFabricsFabricNeighborsResponse(
    RootModel[list[GetNodesNodeSdnFabricsFabricNeighborsResponseItem]]
):
...
class GetNodesNodeSdnFabricsFabricRoutesResponse(
    RootModel[list[GetNodesNodeSdnFabricsFabricRoutesResponseItem]]
):
...
class GetNodesNodeSdnVnetsVnetMacVrfResponse(
    RootModel[list[GetNodesNodeSdnVnetsVnetMacVrfResponseItem]]
):
    root: list[GetNodesNodeSdnVnetsVnetMacVrfResponseItem] = Field(
        ...,
...
class GetNodesNodeSdnZonesZoneBridgesResponseItem(ProxmoxBaseModel):
    ...
    ports: list[dict[str, object]] | None = Field(
        None, description="All ports that are members of the bridge"
    )
    vlan_filtering: str | None = Field(
        None, description="Whether VLAN filtering is enabled for this bridge (= VLAN-aware)."
    )


class GetNodesNodeSdnZonesZoneBridgesResponse(
    RootModel[list[GetNodesNodeSdnZonesZoneBridgesResponseItem]]
):
...
class GetNodesNodeSdnZonesZoneContentResponse(
    RootModel[list[GetNodesNodeSdnZonesZoneContentResponseItem]]
):
...
class GetNodesNodeSdnZonesZoneIpVrfResponseItem(ProxmoxBaseModel):
    ...
    nexthops: list[str] | None = Field(
        None, description="A list of nexthops for the route table entry."
    )
    protocol: str | None = Field(
        None, description="The protocol where this route was learned from (e.g. BGP)."
    )


class GetNodesNodeSdnZonesZoneIpVrfResponse(
    RootModel[list[GetNodesNodeSdnZonesZoneIpVrfResponseItem]]
):
    root: list[GetNodesNodeSdnZonesZoneIpVrfResponseItem] = Field(
        ...,
...
class GetNodesNodeServicesResponseItem(ProxmoxBaseModel):
    ...
    name: str | None = Field(
        None, description='Short identifier for the service (e.g., "pveproxy").'
    )
    service: str | None = Field(None, description="Systemd unit name (e.g., pveproxy).")
    state: str | None = Field(
        None, description="Execution status of the service (systemd SubState)."
    )
    unit_state: str | None = Field(
        None,
        alias="unit-state",
...
class PostNodesNodeSpiceshellRequest(ProxmoxBaseModel):
    cmd: str | None = Field(
        None, description="Run specific command or default to login (requires 'root@pam')"
    )
...
class PostNodesNodeStartallRequest(ProxmoxBaseModel):
    ...
    vms: str | None = Field(
        None, description="Only consider guests from this comma separated list of VMIDs."
    )
...
class GetNodesNodeStatusResponse(ProxmoxBaseModel):
    boot_info: dict[str, object] = Field(
        ..., alias="boot-info", description="Meta-information about the boot mode."
    )
    cpu: float = Field(..., description="The current cpu usage.")
    cpuinfo: dict[str, object] = Field(...)
    current_kernel: dict[str, object] = Field(
        ...,
        alias="current-kernel",
        description="Meta-information about the currently booted kernel of this node.",
    )
    loadavg: list[str] = Field(
...
class PostNodesNodeStopallRequest(ProxmoxBaseModel):
    force_stop: bool | None = Field(
        None, alias="force-stop", description="Force a hard-stop after the timeout."
    )
    timeout: int | None = Field(
        None,
...
class GetNodesNodeStorageStorageContentResponseItem(ProxmoxBaseModel):
    ...
    format: str | None = Field(
        None, description="Format identifier ('raw', 'qcow2', 'subvol', 'iso', 'tgz' ...)"
    )
    ...
    protected: bool | None = Field(
        None, description="Protection status. Currently only supported for backups."
    )
    ...
    verification: dict[str, object] | None = Field(
        None, description="Last backup verification result, only useful for PBS storages."
    )
    vmid: int | None = Field(None, description="Associated Owner VMID.")
    volid: str | None = Field(None, description="Volume identifier.")


class GetNodesNodeStorageStorageContentResponse(
    RootModel[list[GetNodesNodeStorageStorageContentResponseItem]]
):
...
class PostNodesNodeStorageStorageDownloadUrlRequest(ProxmoxBaseModel):
    ...
    verify_certificates: bool | None = Field(
        None,
        alias="verify-certificates",
...
class GetNodesNodeStorageStorageFileRestoreListResponse(
    RootModel[list[GetNodesNodeStorageStorageFileRestoreListResponseItem]]
):
...
class GetNodesNodeStorageStorageImportMetadataResponse(ProxmoxBaseModel):
    create_args: dict[str, object] = Field(
        ...,
        alias="create-args",
        description="Parameters which can be used in a call to create a VM or container.",
    )
    disks: dict[str, object] | None = Field(
        None, description="Recognised disk volumes as `$bus$id` => `$storeid:$path` map."
    )
    net: dict[str, object] | None = Field(
        None, description="Recognised network interfaces as `net$id` => { ...params } object."
    )
    ...
    warnings: list[dict[str, object]] | None = Field(
        None,
...
class DeleteNodesNodeStorageStoragePrunebackupsRequest(ProxmoxBaseModel):
    ...
    type: str | None = Field(
        None, description="Either 'qemu' or 'lxc'. Only consider backups for guests of this type."
    )
...
class GetNodesNodeStorageStoragePrunebackupsResponseItem(ProxmoxBaseModel):
    ctime: int | None = Field(
        None, description="Creation time of the backup (seconds since the UNIX epoch)."
    )
    mark: str | None = Field(
        None,
...
class GetNodesNodeStorageStoragePrunebackupsResponse(
    RootModel[list[GetNodesNodeStorageStoragePrunebackupsResponseItem]]
):
...
class GetNodesNodeSubscriptionResponse(ProxmoxBaseModel):
    ...
    key: str | None = Field(
        None, description="The subscription key, if set and permitted to access."
    )
    ...
    productname: str | None = Field(
        None, description="Human readable productname of the set subscription."
    )
...
class PostNodesNodeSubscriptionRequest(ProxmoxBaseModel):
    force: bool | None = Field(
        None, description="Always connect to server, even if local cache is still valid."
    )
...
class PutPoolsRequest(ProxmoxBaseModel):
    ...
    comment: str | None = Field(None)
    delete: bool | None = Field(
        None, description="Remove the passed VMIDs and/or storage IDs instead of adding them."
    )
    poolid: str = Field(...)
    storage: str | None = Field(
        None, description="List of storage IDs to add or remove from this pool."
    )
    vms: str | None = Field(
        None, description="List of guest VMIDs to add or remove from this pool."
    )
...
class PostStorageRequest(ProxmoxBaseModel):
    ...
    base: str | None = Field(
        None, description="Base volume. This volume is automatically activated."
    )
    ...
    content_dirs: str | None = Field(
        None, alias="content-dirs", description="Overrides for default content type directories."
    )
    create_base_path: bool | None = Field(
        None, alias="create-base-path", description="Create the base directory if it doesn't exist."
    )
    create_subdirs: bool | None = Field(
        None,
        alias="create-subdirs",
        description="Populate the directory with the default structure.",
    )
    data_pool: str | None = Field(
        None, alias="data-pool", description="Data Pool (for erasure coding only)"
    )
    ...
    keyring: str | None = Field(
        None, description="Client keyring contents (for external clusters)."
    )
    ...
    max_protected_backups: int | None = Field(
        None,
        alias="max-protected-backups",
        description="Maximal number of protected backups per guest. Use '-1' for unlimited.",
    )
    mkdir: bool | None = Field(
        None,
    ...
    nodes: str | None = Field(
        None, description="List of nodes for which the storage configuration applies."
    )
    nowritecache: bool | None = Field(None, description="disable write caching on the target")
    options: str | None = Field(
        None, description="NFS/CIFS mount options (see 'man nfs' or 'man mount.cifs')"
    )
    ...
    portal: str | None = Field(
        None, description="iSCSI portal (IP or DNS name with optional port)."
    )
    preallocation: str | None = Field(
        None,
    ...
    saferemove_stepsize: int | None = Field(
        None,
        alias="saferemove-stepsize",
    ...
    saferemove_throughput: str | None = Field(
        None, description="Wipe throughput (cstream -t parameter value)."
    )
    ...
    skip_cert_verification: bool | None = Field(
        None,
        alias="skip-cert-verification",
        description="Disable TLS certificate verification, only enable on fully trusted networks!",
    )
    smbversion: str | None = Field(
        None,
    ...
    snapshot_as_volume_chain: bool | None = Field(
        None,
        alias="snapshot-as-volume-chain",
    ...
    tagged_only: bool | None = Field(
        None, description="Only use logical volumes tagged with 'pve-vm-ID'."
    )
...
class PostStorageResponse(ProxmoxBaseModel):
    config: dict[str, object] | None = Field(
        None, description="Partial, possibly server generated, configuration properties."
    )
