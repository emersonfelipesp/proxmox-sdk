...
class PostAccessDomainsRealmSyncRequest(ProxmoxBaseModel):
    ...
    dry_run: bool | None = Field(
        None, alias="dry-run", description="If set, do not create/delete anything"
    )
...
class PostAccessOpenidLoginResponse(ProxmoxBaseModel):
    ...
    csrfprevention_token: str = Field(
        ..., alias="CSRFPreventionToken", description="Cross Site Request Forgery Prevention Token."
    )
    ticket: str | None = Field(
        None, description="Auth ticket, present if http-only was not provided or is false."
    )
    ticket_info: str | None = Field(
        None,
        alias="ticket-info",
...
class GetAccessTfaResponseItem(ProxmoxBaseModel):
    ...
    totp_locked: bool | None = Field(
        None, alias="totp-locked", description="The user is locked out of TOTP authentication."
    )
...
class PutAccessTfaUseridIdRequest(ProxmoxBaseModel):
    ...
    enable: bool | None = Field(
        None, description="Whether this entry should currently be enabled or disabled"
    )
    password: str | None = Field(None, description="Password.")
...
class PostAccessTicketResponse(ProxmoxBaseModel):
    ...
    csrfprevention_token: str | None = Field(
        None, alias="CSRFPreventionToken", description="The CSRF prevention token."
    )
    ticket: str | None = Field(
        None,
...
class PutAccessUsersUseridTokenTokenNameRequest(ProxmoxBaseModel):
    ...
    regenerate: bool | None = Field(
        None, description="Regenerate token secret while keeping permissions."
    )
...
class GetAdminDatastoreResponseItem(ProxmoxBaseModel):
    ...
    comment: str | None = Field(None, description="Comment.")
    maintenance: str | None = Field(
        None, description="If the datastore is in maintenance mode, information about it"
    )
    mount_status: str | None = Field(
        None,
        alias="mount-status",
...
class GetAdminDatastoreResponse(RootModel[list[GetAdminDatastoreResponseItem]]):
    ...
    root: list[GetAdminDatastoreResponseItem] = Field(
...
class GetAdminDatastoreStoreFilesResponse(RootModel[list[GetAdminDatastoreStoreFilesResponseItem]]):
    ...
    root: list[GetAdminDatastoreStoreFilesResponseItem] = Field(
...
class GetAdminDatastoreStoreGcResponse(ProxmoxBaseModel):
    ...
    cache_stats: dict[str, object] | None = Field(
        None, alias="cache-stats", description="Garbage collection cache statistics"
    )
    ...
    index_data_bytes: int = Field(
        ..., alias="index-data-bytes", description="Sum of bytes referred by index files."
    )
    index_file_count: int = Field(
        ..., alias="index-file-count", description="Number of processed index files."
    )
    last_run_endtime: int | None = Field(
        None, alias="last-run-endtime", description="Endtime of the last gc run"
    )
    last_run_state: str | None = Field(
        None, alias="last-run-state", description="State of the last gc run"
    )
    next_run: int | None = Field(None, alias="next-run", description="Time of the next gc run")
    pending_bytes: int = Field(
        ...,
        alias="pending-bytes",
    ...
    removed_chunks: int = Field(
        ..., alias="removed-chunks", description="Number of removed chunks."
    )
...
class DeleteAdminDatastoreStoreGroupsRequest(ProxmoxBaseModel):
    ...
    backup_id: str = Field(..., alias="backup-id", description="Backup ID.")
    backup_type: str = Field(..., alias="backup-type", description="Backup types.")
    error_on_protected: bool | None = Field(
        None,
        alias="error-on-protected",
...
class DeleteAdminDatastoreStoreGroupsResponse(ProxmoxBaseModel):
    ...
    protected_snapshots: int = Field(
        ..., alias="protected-snapshots", description="Number of entities"
    )
...
class GetAdminDatastoreStoreGroupsResponseItem(ProxmoxBaseModel):
    ...
    backup_count: int | None = Field(
        None, alias="backup-count", description="Number of contained snapshots"
    )
    ...
    last_backup: int | None = Field(
        None, alias="last-backup", description="Backup time (Unix epoch.)"
    )
    owner: str | None = Field(None, description="Authentication ID")


class GetAdminDatastoreStoreGroupsResponse(
    RootModel[list[GetAdminDatastoreStoreGroupsResponseItem]]
):
    """List of items. None. List backup groups. response."""

    root: list[GetAdminDatastoreStoreGroupsResponseItem] = Field(
...
class GetAdminDatastoreStoreNamespaceResponse(
    RootModel[list[GetAdminDatastoreStoreNamespaceResponseItem]]
):
    """List of items. None. List the namespaces of a datastore. response."""

    root: list[GetAdminDatastoreStoreNamespaceResponseItem] = Field(
...
class PostAdminDatastoreStorePruneRequest(ProxmoxBaseModel):
    ...
    keep_daily: int | None = Field(
        None, alias="keep-daily", description="Number of daily backups to keep."
    )
    keep_hourly: int | None = Field(
        None, alias="keep-hourly", description="Number of hourly backups to keep."
    )
    keep_last: int | None = Field(None, alias="keep-last", description="Number of backups to keep.")
    keep_monthly: int | None = Field(
        None, alias="keep-monthly", description="Number of monthly backups to keep."
    )
    keep_weekly: int | None = Field(
        None, alias="keep-weekly", description="Number of weekly backups to keep."
    )
    keep_yearly: int | None = Field(
        None, alias="keep-yearly", description="Number of yearly backups to keep."
    )
    ns: str | None = Field(None, description="Namespace.")
    use_task: bool | None = Field(
        None, alias="use-task", description="Spins up an asynchronous task that does the work."
    )
...
class PostAdminDatastoreStorePruneResponseItem(ProxmoxBaseModel):
    ...
    backup_id: str | None = Field(None, alias="backup-id", description="Backup ID.")
    backup_time: int | None = Field(
        None, alias="backup-time", description="Backup time (Unix epoch.)"
    )
    backup_type: str | None = Field(None, alias="backup-type", description="Backup types.")
    keep: bool | None = Field(None, description="Keep snapshot")


class PostAdminDatastoreStorePruneResponse(
    RootModel[list[PostAdminDatastoreStorePruneResponseItem]]
):
    """List of items. None. Prune a group on the datastore response."""

    root: list[PostAdminDatastoreStorePruneResponseItem] = Field(
        ...,
...
class GetAdminDatastoreStoreSnapshotsResponse(
    RootModel[list[GetAdminDatastoreStoreSnapshotsResponseItem]]
):
    """List of items. None. List backup snapshots. response."""

    root: list[GetAdminDatastoreStoreSnapshotsResponseItem] = Field(
...
class GetAdminDatastoreStoreStatusResponse(ProxmoxBaseModel):
    ...
    counts: dict[str, object] | None = Field(
        None, description="Counts of groups/snapshots per BackupType."
    )
    gc_status: dict[str, object] | None = Field(
        None, alias="gc-status", description="Garbage collection status."
    )
...
class PostAdminDatastoreStoreVerifyRequest(ProxmoxBaseModel):
    ...
    backup_type: str | None = Field(None, alias="backup-type", description="Backup types.")
    ignore_verified: bool | None = Field(
        None,
        alias="ignore-verified",
...
class GetAdminGcResponseItem(ProxmoxBaseModel):
    ...
    duration: int | None = Field(None, description="Duration of last gc run")
    index_data_bytes: int | None = Field(
        None, alias="index-data-bytes", description="Sum of bytes referred by index files."
    )
    index_file_count: int | None = Field(
        None, alias="index-file-count", description="Number of processed index files."
    )
    last_run_endtime: int | None = Field(
        None, alias="last-run-endtime", description="Endtime of the last gc run"
    )
    ...
    next_run: int | None = Field(None, alias="next-run", description="Time of the next gc run")
    pending_bytes: int | None = Field(
        None,
        alias="pending-bytes",
        description="Sum of pending bytes (pending removal - kept for safety).",
    )
    pending_chunks: int | None = Field(
        None,
        alias="pending-chunks",
        description="Number of pending chunks (pending removal - kept for safety).",
    )
    removed_bad: int | None = Field(
        None,
        alias="removed-bad",
        description="Number of chunks marked as .bad by verify that have been removed by GC.",
    )
    removed_bytes: int | None = Field(
        None, alias="removed-bytes", description="Sum of removed bytes."
    )
    removed_chunks: int | None = Field(
        None, alias="removed-chunks", description="Number of removed chunks."
    )
    schedule: str | None = Field(None, description="Schedule of the gc job")
    still_bad: int | None = Field(
        None,
        alias="still-bad",
        description="Number of chunks still marked as .bad after garbage collection.",
    )
...
class GetAdminGcResponse(RootModel[list[GetAdminGcResponseItem]]):
    ...
    root: list[GetAdminGcResponseItem] = Field(
...
class GetAdminGcStoreResponse(RootModel[list[GetAdminGcStoreResponseItem]]):
    ...
    root: list[GetAdminGcStoreResponseItem] = Field(
        ..., description="List configured gc jobs and their status"
    )
...
class GetAdminMetricsResponse(RootModel[list[GetAdminMetricsResponseItem]]):
    ...
    root: list[GetAdminMetricsResponseItem] = Field(
...
class GetAdminPruneResponseItem(ProxmoxBaseModel):
    ...
    last_run_endtime: int | None = Field(
        None, alias="last-run-endtime", description="Endtime of the last run."
    )
    last_run_state: str | None = Field(
        None, alias="last-run-state", description="Result of the last run."
    )
    last_run_upid: str | None = Field(
        None, alias="last-run-upid", description="Task UPID of the last run."
    )
    max_depth: int | None = Field(
        None,
        alias="max-depth",
    ...
    next_run: int | None = Field(
        None, alias="next-run", description="Estimated time of the next run (UNIX epoch)."
    )
    ns: str | None = Field(None, description="Namespace.")
...
class GetAdminPruneResponse(RootModel[list[GetAdminPruneResponseItem]]):
    ...
    root: list[GetAdminPruneResponseItem] = Field(
...
class GetAdminSyncResponseItem(ProxmoxBaseModel):
    ...
    ns: str | None = Field(None, description="Namespace.")
    owner: str | None = Field(None, description="Authentication ID")
    rate_in: str | None = Field(
        None,
        alias="rate-in",
        description="Byte size with optional unit (B, KB (base 10), MB, GB, ..., KiB (base 2), MiB, Gib, ...).",
    )
    rate_out: str | None = Field(
        None,
        alias="rate-out",
        description="Byte size with optional unit (B, KB (base 10), MB, GB, ..., KiB (base 2), MiB, Gib, ...).",
    )
    ...
    remove_vanished: bool | None = Field(
        None,
        alias="remove-vanished",
        description="Delete vanished backups. This remove the local copy if the remote backup was deleted.",
    )
    resync_corrupt: bool | None = Field(
        None,
        alias="resync-corrupt",
        description="If the verification failed for a local snapshot, try to pull it again.",
    )
    run_on_mount: bool | None = Field(
        None, alias="run-on-mount", description="Run this job when a relevant datastore is mounted."
    )
    schedule: str | None = Field(None, description="Run sync job at specified schedule.")
    store: str | None = Field(None, description="Datastore name.")
    sync_direction: str | None = Field(
        None, alias="sync-direction", description="Direction of the sync job, push or pull"
    )
    transfer_last: int | None = Field(
        None,
        alias="transfer-last",
        description="Limit transfer to last N snapshots (per group), skipping others",
    )
    unmount_on_done: bool | None = Field(
        None,
        alias="unmount-on-done",
...
class GetAdminSyncResponse(RootModel[list[GetAdminSyncResponseItem]]):
    ...
    root: list[GetAdminSyncResponseItem] = Field(
...
class GetAdminTrafficControlResponseItem(ProxmoxBaseModel):
    ...
    comment: str | None = Field(None, description="Comment.")
    cur_rate_in: int | None = Field(
        None, alias="cur-rate-in", description="Current ingress rate in bytes/second"
    )
    cur_rate_out: int | None = Field(
        None, alias="cur-rate-out", description="Current egress rate in bytes/second"
    )
    name: str | None = Field(None, description="Rule ID.")
    network: list[str] | None = Field(
        None, description="Rule applies to Source IPs within this networks"
    )
    rate_in: str | None = Field(
        None,
        alias="rate-in",
...
class GetAdminTrafficControlResponse(RootModel[list[GetAdminTrafficControlResponseItem]]):
    ...
    root: list[GetAdminTrafficControlResponseItem] = Field(
...
class GetAdminVerifyResponse(RootModel[list[GetAdminVerifyResponseItem]]):
    ...
    root: list[GetAdminVerifyResponseItem] = Field(
        ..., description="List configured jobs and their status (filtered by access)"
    )
...
class GetConfigAccessAdResponseItem(ProxmoxBaseModel):
    ...
    default: bool | None = Field(
        None, description="True if you want this to be the default realm selected on login."
    )
    ...
    sync_defaults_options: str | None = Field(
        None, alias="sync-defaults-options", description="sync defaults options"
    )
...
class GetConfigAccessAdResponse(RootModel[list[GetConfigAccessAdResponseItem]]):
    ...
    root: list[GetConfigAccessAdResponseItem] = Field(
...
class GetConfigAccessLdapResponse(RootModel[list[GetConfigAccessLdapResponseItem]]):
    ...
    root: list[GetConfigAccessLdapResponseItem] = Field(
...
class GetConfigAccessOpenidResponse(RootModel[list[GetConfigAccessOpenidResponseItem]]):
    ...
    root: list[GetConfigAccessOpenidResponseItem] = Field(
...
class GetConfigAcmeChallengeSchemaResponse(
    RootModel[list[GetConfigAcmeChallengeSchemaResponseItem]]
):
    """List of items. None. Get named known ACME directory endpoints. response."""

    root: list[GetConfigAcmeChallengeSchemaResponseItem] = Field(
...
class GetConfigAcmeDirectoriesResponse(RootModel[list[GetConfigAcmeDirectoriesResponseItem]]):
    ...
    root: list[GetConfigAcmeDirectoriesResponseItem] = Field(
...
class GetConfigAcmePluginsResponse(RootModel[list[GetConfigAcmePluginsResponseItem]]):
    ...
    root: list[GetConfigAcmePluginsResponseItem] = Field(
...
class GetConfigChangerResponseItem(ProxmoxBaseModel):
    ...
    eject_before_unload: bool | None = Field(
        None,
        alias="eject-before-unload",
        description="if set to true, tapes are ejected manually before unloading",
    )
    export_slots: str | None = Field(
        None,
        alias="export-slots",
    ...
    path: str | None = Field(
        None, description="Path to Linux generic SCSI device (e.g. '/dev/sg4')"
    )
...
class GetConfigChangerResponse(RootModel[list[GetConfigChangerResponseItem]]):
    ...
    root: list[GetConfigChangerResponseItem] = Field(
...
class GetConfigDatastoreResponseItem(ProxmoxBaseModel):
    ...
    backing_device: str | None = Field(
        None,
        alias="backing-device",
        description="The UUID of the filesystem partition for removable datastores.",
    )
    comment: str | None = Field(None, description="Comment.")
    gc_schedule: str | None = Field(
        None, alias="gc-schedule", description="Run garbage collection job at specified schedule."
    )
    keep_daily: int | None = Field(
        None, alias="keep-daily", description="Number of daily backups to keep."
    )
    ...
    maintenance_mode: str | None = Field(
        None,
    ...
    prune_schedule: str | None = Field(
        None, alias="prune-schedule", description="Run prune job at specified schedule."
    )
    tuning: str | None = Field(None, description="Datastore tuning options")
    verify_new: bool | None = Field(
        None,
        alias="verify-new",
...
class GetConfigDatastoreResponse(RootModel[list[GetConfigDatastoreResponseItem]]):
    ...
    root: list[GetConfigDatastoreResponseItem] = Field(
...
class PostConfigDatastoreRequest(ProxmoxBaseModel):
    ...
    notify_user: str | None = Field(None, alias="notify-user", description="User ID")
    overwrite_in_use: bool | None = Field(
        None,
        alias="overwrite-in-use",
    ...
    reuse_datastore: bool | None = Field(
        None, alias="reuse-datastore", description="Re-use existing datastore directory."
    )
    tuning: str | None = Field(None, description="Datastore tuning options")
    verify_new: bool | None = Field(
        None,
...
class DeleteConfigDatastoreNameRequest(ProxmoxBaseModel):
    ...
    destroy_data: bool | None = Field(
        None, alias="destroy-data", description="Delete the datastore's underlying contents"
    )
    digest: str | None = Field(
        None,
        description="Prevent changes if current configuration file has different SHA256 digest. This can be used to prevent concurrent modifications.",
    )
    keep_job_configs: bool | None = Field(
        None,
        alias="keep-job-configs",
...
class GetConfigDriveResponseItem(ProxmoxBaseModel):
    ...
    changer_drivenum: int | None = Field(
        None,
        alias="changer-drivenum",
        description="Associated changer drive number (requires option changer)",
    )
    name: str | None = Field(None, description="Drive Identifier.")
    path: str | None = Field(
        None, description="The path to a LTO SCSI-generic tape device (i.e. '/dev/sg0')"
    )
...
class GetConfigDriveResponse(RootModel[list[GetConfigDriveResponseItem]]):
    ...
    root: list[GetConfigDriveResponseItem] = Field(
...
class GetConfigMediaPoolResponseItem(ProxmoxBaseModel):
    ...
    allocation: str | None = Field(
        None, description="Media set allocation policy ('continue', 'always', or a calendar event)."
    )
    comment: str | None = Field(None, description="Comment.")
    ...
    retention: str | None = Field(
        None, description="Media retention policy ('overwrite', 'keep', or time span)."
    )
...
class GetConfigMediaPoolResponse(RootModel[list[GetConfigMediaPoolResponseItem]]):
    ...
    root: list[GetConfigMediaPoolResponseItem] = Field(
...
class GetConfigMetricsInfluxdbHttpResponseItem(ProxmoxBaseModel):
    ...
    max_body_size: int | None = Field(
        None, alias="max-body-size", description="The (optional) maximum body size"
    )
    name: str | None = Field(None, description="Metrics Server ID.")
    ...
    verify_tls: bool | None = Field(
        None, alias="verify-tls", description="If true, the certificate will be validated."
    )


class GetConfigMetricsInfluxdbHttpResponse(
    RootModel[list[GetConfigMetricsInfluxdbHttpResponseItem]]
):
    """List of items. None. List configured InfluxDB http metric servers. response."""

    root: list[GetConfigMetricsInfluxdbHttpResponseItem] = Field(
...
class GetConfigMetricsInfluxdbUdpResponseItem(ProxmoxBaseModel):
    ...
    enable: bool | None = Field(None, description="Enables or disables the metrics server")
    host: str | None = Field(
        None, description="host:port combination (Host can be DNS name or IP address)."
    )
...
class GetConfigMetricsInfluxdbUdpResponse(RootModel[list[GetConfigMetricsInfluxdbUdpResponseItem]]):
    ...
    root: list[GetConfigMetricsInfluxdbUdpResponseItem] = Field(
...
class GetConfigNotificationsEndpointsGotifyResponseItem(ProxmoxBaseModel):
    ...
    origin: str | None = Field(
        None, description="The origin of a notification configuration entry."
    )
    server: str | None = Field(None, description="Gotify Server URL.")


class GetConfigNotificationsEndpointsGotifyResponse(
    RootModel[list[GetConfigNotificationsEndpointsGotifyResponseItem]]
):
    """List of items. None. List all gotify endpoints. response."""

    root: list[GetConfigNotificationsEndpointsGotifyResponseItem] = Field(
...
class GetConfigNotificationsEndpointsSendmailResponseItem(ProxmoxBaseModel):
    ...
    author: str | None = Field(
        None, description="Author of the mail. Defaults to 'Proxmox Backup Server ($hostname)'"
    )
    comment: str | None = Field(None, description="Comment.")
    disable: bool | None = Field(None, description="Disable this target.")
    filter: str | None = Field(None, description="Deprecated.")
    ...
    mailto_user: list[str] | None = Field(
        None,
        alias="mailto-user",
...
class GetConfigNotificationsEndpointsSendmailResponse(
    RootModel[list[GetConfigNotificationsEndpointsSendmailResponseItem]]
):
    """List of items. None. List all sendmail endpoints. response."""

    root: list[GetConfigNotificationsEndpointsSendmailResponseItem] = Field(
...
class GetConfigNotificationsEndpointsSmtpResponse(
    RootModel[list[GetConfigNotificationsEndpointsSmtpResponseItem]]
):
    """List of items. None. List all smtp endpoints. response."""

    root: list[GetConfigNotificationsEndpointsSmtpResponseItem] = Field(
...
class GetConfigNotificationsEndpointsWebhookResponse(
    RootModel[list[GetConfigNotificationsEndpointsWebhookResponseItem]]
):
    """List of items. None. List all webhook endpoints. response."""

    root: list[GetConfigNotificationsEndpointsWebhookResponseItem] = Field(
...
class GetConfigNotificationsMatcherFieldValuesResponse(
    RootModel[list[GetConfigNotificationsMatcherFieldValuesResponseItem]]
):
    """List of items. None. List all known, matchable metadata field values. response."""

    root: list[GetConfigNotificationsMatcherFieldValuesResponseItem] = Field(
...
class GetConfigNotificationsMatcherFieldsResponse(
    RootModel[list[GetConfigNotificationsMatcherFieldsResponseItem]]
):
    """List of items. None. Get all known metadata fields. response."""

    root: list[GetConfigNotificationsMatcherFieldsResponseItem] = Field(
...
class GetConfigNotificationsMatchersResponseItem(ProxmoxBaseModel):
    ...
    invert_match: bool | None = Field(
        None, alias="invert-match", description="Invert match of the whole filter."
    )
    match_calendar: list[str] | None = Field(
        None, alias="match-calendar", description="List of matched severity levels."
    )
    match_field: list[str] | None = Field(
        None, alias="match-field", description="List of matched metadata fields."
    )
    match_severity: list[str] | None = Field(
        None, alias="match-severity", description="List of matched severity levels."
    )
    mode: str | None = Field(
        None, description="The mode in which the results of matches are combined."
    )
    name: str | None = Field(None, description="Name schema for targets and matchers")
    origin: str | None = Field(
        None, description="The origin of a notification configuration entry."
...
class GetConfigNotificationsMatchersResponse(
    RootModel[list[GetConfigNotificationsMatchersResponseItem]]
):
    """List of items. None. List all notification matchers. response."""

    root: list[GetConfigNotificationsMatchersResponseItem] = Field(
...
class GetConfigNotificationsTargetsResponse(
    RootModel[list[GetConfigNotificationsTargetsResponseItem]]
):
    """List of items. None. List all notification targets. response."""

    root: list[GetConfigNotificationsTargetsResponseItem] = Field(
...
class GetConfigPruneResponse(RootModel[list[GetConfigPruneResponseItem]]):
    ...
    root: list[GetConfigPruneResponseItem] = Field(
...
class GetConfigRemoteResponseItem(ProxmoxBaseModel):
    ...
    use_node_proxy: bool | None = Field(
        None,
        alias="use-node-proxy",
...
class GetConfigRemoteResponse(RootModel[list[GetConfigRemoteResponseItem]]):
    ...
    root: list[GetConfigRemoteResponseItem] = Field(
...
class GetConfigRemoteNameScanResponse(RootModel[list[GetConfigRemoteNameScanResponseItem]]):
    ...
    root: list[GetConfigRemoteNameScanResponseItem] = Field(
        ..., description="List the accessible datastores."
    )
...
class GetConfigRemoteNameScanStoreGroupsResponse(
    RootModel[list[GetConfigRemoteNameScanStoreGroupsResponseItem]]
):
    """List of items. None. List groups of a remote.cfg entry's datastore response."""

    root: list[GetConfigRemoteNameScanStoreGroupsResponseItem] = Field(
...
class GetConfigRemoteNameScanStoreNamespacesResponse(
    RootModel[list[GetConfigRemoteNameScanStoreNamespacesResponseItem]]
):
    """List of items. None. List namespaces of a datastore of a remote.cfg entry response."""

    root: list[GetConfigRemoteNameScanStoreNamespacesResponseItem] = Field(
...
class GetConfigS3ResponseItem(ProxmoxBaseModel):
    ...
    access_key: str | None = Field(
        None, alias="access-key", description="Access key for S3 object store."
    )
    burst_in: str | None = Field(
        None,
        alias="burst-in",
    ...
    path_style: bool | None = Field(
        None, alias="path-style", description="Use path style bucket addressing over vhost style."
    )
    port: int | None = Field(None, description="Port to access S3 object store.")
    provider_quirks: list[str] | None = Field(
        None,
        alias="provider-quirks",
        description="List of provider specific feature implementation quirks.",
    )
    put_rate_limit: int | None = Field(
        None, alias="put-rate-limit", description="Rate limit for put requests given as #request/s."
    )
    rate_in: str | None = Field(
        None,
        alias="rate-in",
...
class GetConfigTapeBackupJobResponseItem(ProxmoxBaseModel):
    ...
    eject_media: bool | None = Field(
        None, alias="eject-media", description="Eject media upon job completion."
    )
    export_media_set: bool | None = Field(
        None, alias="export-media-set", description="Export media set upon job completion."
    )
    group_filter: list[str] | None = Field(
        None, alias="group-filter", description="List of group filters."
    )
    ...
    latest_only: bool | None = Field(
        None, alias="latest-only", description="Backup latest snapshots only."
    )
    max_depth: int | None = Field(
        None,
        alias="max-depth",
...
class GetConfigTapeEncryptionKeysResponseItem(ProxmoxBaseModel):
    ...
    kdf: str | None = Field(
        None, description="Key derivation function for password protected encryption keys."
    )
...
class GetConfigTapeEncryptionKeysResponse(RootModel[list[GetConfigTapeEncryptionKeysResponseItem]]):
    ...
    root: list[GetConfigTapeEncryptionKeysResponseItem] = Field(
...
class GetConfigTrafficControlResponse(RootModel[list[GetConfigTrafficControlResponseItem]]):
    ...
    root: list[GetConfigTrafficControlResponseItem] = Field(
...
class GetNodesNodeAptUpdateResponseItem(ProxmoxBaseModel):
    ...
    description: str | None = Field(
        None, alias="Description", description="Human readable package description"
    )
    extra_info: str | None = Field(
        None, alias="ExtraInfo", description="Custom extra field for additional package information"
    )
    ...
    priority: str | None = Field(
        None, alias="Priority", description="Package priority in human-readable form"
    )
...
class PostNodesNodeCertificatesCustomResponseItem(ProxmoxBaseModel):
    ...
    public_key_bits: int | None = Field(
        None, alias="public-key-bits", description="Certificate's public key size if available."
    )
...
class PostNodesNodeCertificatesCustomResponse(
    RootModel[list[PostNodesNodeCertificatesCustomResponseItem]]
):
    """List of items. None. Upload a custom certificate. response."""

    root: list[PostNodesNodeCertificatesCustomResponseItem] = Field(
...
class GetNodesNodeConfigResponse(ProxmoxBaseModel):
    ...
    ciphers_tls_1_2: str | None = Field(
        None,
        alias="ciphers-tls-1.2",
        description="OpenSSL cipher list used by the proxy for TLS <= 1.2",
    )
    ciphers_tls_1_3: str | None = Field(
        None,
        alias="ciphers-tls-1.3",
    ...
    http_proxy: str | None = Field(
        None, alias="http-proxy", description="HTTP proxy configuration [http://]<host>[:port]"
    )
    task_log_max_days: int | None = Field(
        None, alias="task-log-max-days", description="Maximum days to keep Task logs"
    )
...
class PostNodesNodeDisksDirectoryRequest(ProxmoxBaseModel):
    ...
    add_datastore: bool | None = Field(
        None, alias="add-datastore", description="Configure a datastore using the directory."
    )
    disk: str = Field(..., description="Block device name (/sys/block/<name>).")
    filesystem: str | None = Field(None, description="A file system type supported by our tooling.")
    name: str = Field(..., description="Datastore name.")
    removable_datastore: bool | None = Field(
        None, alias="removable-datastore", description="The added datastore is removable."
    )
...
class GetNodesNodeDisksListResponseItem(ProxmoxBaseModel):
    ...
    disk_type: str | None = Field(
        None, alias="disk-type", description='This is just a rough estimate for a "type" of disk.'
    )
...
class PostNodesNodeDisksZfsRequest(ProxmoxBaseModel):
    ...
    add_datastore: bool | None = Field(
        None, alias="add-datastore", description="Configure a datastore using the zpool."
    )
...
class GetNodesNodeNetworkResponseItem(ProxmoxBaseModel):
    ...
    bond_primary: str | None = Field(
        None, alias="bond-primary", description="Network interface name."
    )
    bond_mode: str | None = Field(None, description="Linux Bond Mode")
    bond_xmit_hash_policy: str | None = Field(
        None, description="Bond Transmit Hash Policy for LACP (802.3ad)"
    )
    ...
    vlan_raw_device: str | None = Field(
        None, alias="vlan-raw-device", description="Network interface name."
    )
...
class PostNodesNodeNetworkRequest(ProxmoxBaseModel):
    ...
    bridge_ports: str | None = Field(
        None, description="A list of network devices, comma separated."
    )
    bridge_vlan_aware: bool | None = Field(None, description="Enable bridge vlan support.")
    cidr: str | None = Field(None, description="IPv4 address with netmask (CIDR notation).")
    cidr6: str | None = Field(None, description="IPv6 address with netmask (CIDR notation).")
...
class GetNodesNodeServicesResponseItem(ProxmoxBaseModel):
    ...
    unit_state: str | None = Field(
        None, alias="unit-state", description="systemd service unit state."
    )
...
class GetNodesNodeStatusResponse(ProxmoxBaseModel):
    ...
    current_kernel: dict[str, object] = Field(
        ..., alias="current-kernel", description="The current kernel version (output of `uname`)"
    )
...
class PostNodesNodeSubscriptionRequest(ProxmoxBaseModel):
    ...
    force: bool | None = Field(
        None, description="Always connect to server, even if information in cache is up to date."
    )
...
class GetStatusDatastoreUsageResponseItem(ProxmoxBaseModel):
    ...
    avail: int | None = Field(
        None, description="The available bytes of the underlying storage. (-1 on error)"
    )
    backend_type: str | None = Field(
        None, alias="backend-type", description="Datastore backend type"
    )
    error: str | None = Field(
        None,
        description="An error description, for example, when the datastore could not be looked up",
    )
    estimated_full_date: int | None = Field(
        None,
        alias="estimated-full-date",
    ...
    history: list[float] | None = Field(
        None, description="A list of usages of the past (last Month)."
    )
    history_delta: int | None = Field(
        None, alias="history-delta", description="History resolution (seconds)"
    )
    history_start: int | None = Field(
        None, alias="history-start", description="History start time (epoch)"
    )
    mount_status: str | None = Field(
        None,
        alias="mount-status",
...
class GetStatusDatastoreUsageResponse(RootModel[list[GetStatusDatastoreUsageResponseItem]]):
    ...
    root: list[GetStatusDatastoreUsageResponseItem] = Field(
...
class GetTapeBackupResponseItem(ProxmoxBaseModel):
    ...
    next_media_label: str | None = Field(
        None, alias="next-media-label", description="Next tape used (best guess)"
    )
    next_run: int | None = Field(
        None, alias="next-run", description="Estimated time of the next run (UNIX epoch)."
    )
...
class GetTapeBackupResponse(RootModel[list[GetTapeBackupResponseItem]]):
    ...
    root: list[GetTapeBackupResponseItem] = Field(
...
class PostTapeBackupRequest(ProxmoxBaseModel):
    ...
    force_media_set: bool | None = Field(
        None,
        alias="force-media-set",
...
class GetTapeChangerResponse(RootModel[list[GetTapeChangerResponseItem]]):
    ...
    root: list[GetTapeChangerResponseItem] = Field(
...
class GetTapeChangerNameStatusResponseItem(ProxmoxBaseModel):
    ...
    loaded_slot: int | None = Field(
        None, alias="loaded-slot", description="The slot the drive was loaded from"
    )
...
class GetTapeChangerNameStatusResponse(RootModel[list[GetTapeChangerNameStatusResponseItem]]):
    ...
    root: list[GetTapeChangerNameStatusResponseItem] = Field(
...
class GetTapeDriveResponseItem(ProxmoxBaseModel):
    ...
    activity: str | None = Field(
        None, description="The DT Device Activity from DT Device Status LP page"
    )
    changer: str | None = Field(None, description="Tape Changer Identifier.")
    changer_drivenum: int | None = Field(
        None,
...
class GetTapeDriveResponse(RootModel[list[GetTapeDriveResponseItem]]):
    ...
    root: list[GetTapeDriveResponseItem] = Field(
...
class GetTapeDriveDriveCartridgeMemoryResponse(
    RootModel[list[GetTapeDriveDriveCartridgeMemoryResponseItem]]
):
    """List of items. None. Read Cartridge Memory (Medium auxiliary memory attributes) response."""

    root: list[GetTapeDriveDriveCartridgeMemoryResponseItem] = Field(
...
class GetTapeDriveDriveInventoryResponseItem(ProxmoxBaseModel):
    ...
    label_text: str | None = Field(
        None, alias="label-text", description="Changer label text (or Barcode)"
    )
...
class GetTapeDriveDriveInventoryResponse(RootModel[list[GetTapeDriveDriveInventoryResponseItem]]):
    ...
    root: list[GetTapeDriveDriveInventoryResponseItem] = Field(
...
class PutTapeDriveDriveInventoryRequest(ProxmoxBaseModel):
    ...
    read_all_labels: bool | None = Field(
        None,
        alias="read-all-labels",
...
class GetTapeDriveDriveReadLabelResponse(ProxmoxBaseModel):
    ...
    encryption_key_fingerprint: str | None = Field(
        None, alias="encryption-key-fingerprint", description="Encryption key fingerprint"
    )
    label_text: str = Field(..., alias="label-text", description="Media label text (or Barcode)")
    media_set_ctime: int | None = Field(
        None, alias="media-set-ctime", description="MediaSet Creation time stamp"
    )
    media_set_uuid: str | None = Field(
        None,
        alias="media-set-uuid",
...
class GetTapeDriveDriveStatusResponse(ProxmoxBaseModel):
    ...
    bytes_read: int | None = Field(
        None, alias="bytes-read", description="Total Bytes Read in Medium Life"
    )
    bytes_written: int | None = Field(
        None, alias="bytes-written", description="Total Bytes Written in Medium Life"
    )
    compression: bool = Field(..., description="Compression enabled")
    density: str | None = Field(
        None, description="The density of a tape medium, derived from the LTO version."
    )
    drive_activity: str | None = Field(
        None,
        alias="drive-activity",
    ...
    medium_passes: int | None = Field(
        None,
        alias="medium-passes",
        description="Count of the total number of times the medium has passed over\nthe head.",
    )
    medium_wearout: float | None = Field(
        None,
        alias="medium-wearout",
    ...
    volume_mounts: int | None = Field(
        None,
        alias="volume-mounts",
        description="Number of mounts for the current volume (i.e., Thread Count)",
    )
    write_protect: bool | None = Field(
        None, alias="write-protect", description="Media is write protected"
    )
...
class GetTapeDriveDriveVolumeStatisticsResponse(ProxmoxBaseModel):
    ...
    beginning_of_medium_passes: int = Field(
        ..., alias="beginning-of-medium-passes", description="Beginning of medium passes"
    )
    last_load_read_compression_ratio: int = Field(
        ...,
        alias="last-load-read-compression-ratio",
        description="Last load read compression ratio",
    )
    last_load_write_compression_ratio: int = Field(
        ...,
        alias="last-load-write-compression-ratio",
        description="Last load write compression ratio",
    )
    last_mount_bytes_read: int = Field(
        ..., alias="last-mount-bytes-read", description="Last mount bytes read"
    )
    last_mount_bytes_written: int = Field(
        ..., alias="last-mount-bytes-written", description="Last mount bytes written"
    )
    last_mount_unrecovered_read_errors: int = Field(
        ...,
        alias="last-mount-unrecovered-read-errors",
        description="Last mount unrecovered read errors",
    )
    last_mount_unrecovered_write_errors: int = Field(
        ...,
        alias="last-mount-unrecovered-write-errors",
        description="Last mount unrecovered write errors",
    )
    lifetime_bytes_read: int = Field(
        ..., alias="lifetime-bytes-read", description="Lifetime bytes read"
    )
    lifetime_bytes_written: int = Field(
        ..., alias="lifetime-bytes-written", description="Lifetime bytes written"
    )
    ...
    middle_of_tape_passes: int = Field(
        ..., alias="middle-of-tape-passes", description="Middle of medium passes"
    )
    serial: str = Field(..., description="Volume serial number")
    total_native_capacity: int = Field(
        ..., alias="total-native-capacity", description="Total native capacity"
    )
    total_used_native_capacity: int = Field(
        ..., alias="total-used-native-capacity", description="Total used native capacity"
    )
    volume_datasets_read: int = Field(
        ..., alias="volume-datasets-read", description="Total datasets read"
    )
    volume_datasets_written: int = Field(
        ..., alias="volume-datasets-written", description="Total data sets written"
    )
    volume_mounts: int = Field(
        ..., alias="volume-mounts", description="Volume mounts (thread count)"
    )
    volume_recovered_read_errors: int = Field(
        ..., alias="volume-recovered-read-errors", description="Total read retries"
    )
    volume_recovered_write_data_errors: int = Field(
        ..., alias="volume-recovered-write-data-errors", description="Write retries"
    )
    volume_unrecovered_read_errors: int = Field(
        ..., alias="volume-unrecovered-read-errors", description="Total unrecovered read errors"
    )
    volume_unrecovered_write_data_errors: int = Field(
        ...,
        alias="volume-unrecovered-write-data-errors",
        description="Total unrecovered write errors",
    )
    volume_unrecovered_write_servo_errors: int = Field(
        ...,
        alias="volume-unrecovered-write-servo-errors",
        description="Total fatal suspended writes",
    )
    volume_write_servo_errors: int = Field(
        ..., alias="volume-write-servo-errors", description="Total suspended writes"
    )
...
class GetTapeMediaContentResponseItem(ProxmoxBaseModel):
    ...
    backup_time: int | None = Field(
        None, alias="backup-time", description="Snapshot creation time (epoch)"
    )
    label_text: str | None = Field(
        None, alias="label-text", description="Media label text (or Barcode)"
    )
    media_set_ctime: int | None = Field(
        None, alias="media-set-ctime", description="MediaSet Creation time stamp"
    )
...
class GetTapeMediaListResponse(RootModel[list[GetTapeMediaListResponseItem]]):
    ...
    root: list[GetTapeMediaListResponseItem] = Field(
...
class GetTapeScanChangersResponse(RootModel[list[GetTapeScanChangersResponseItem]]):
    ...
    root: list[GetTapeScanChangersResponseItem] = Field(
...
class GetTapeScanDrivesResponse(RootModel[list[GetTapeScanDrivesResponseItem]]):
    ...
    root: list[GetTapeScanDrivesResponseItem] = Field(
